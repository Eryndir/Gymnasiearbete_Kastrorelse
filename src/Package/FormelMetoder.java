...
public class FormelMetoder {
    ...
    //
    //
    //VIKTIGT FLYTTA LUFTMOTSTÅNDS RELEVANTA SAKER TILL DEN NYA KLASSEN
    ...
    /*
    public double xPositionLuft() {
        
    }
    
    public double yPositionLuft() {
        
    }
    
    public double xHastughetLuft() {
        
    }
    
    public double yHadtighetLuft() {
