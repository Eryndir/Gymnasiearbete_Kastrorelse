...
public class GrafRitare {
    ...
    public ArrayList positionRaknare(double deltaT) { //räknar ut alla positioner vid varje tidpunkt
    ...
    //metod som räknar ut alla värden av kaströrelse mrf luftmotstånd och ger ut en lista av värdena som ska visas för läsaren
